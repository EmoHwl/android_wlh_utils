...
public class Downloader {
    ...
    private DownloaderResponseBody.ProgressListener progressListener;
    private String url;
    private OkHttpClient client;
    private File destination;
    private Call call;

    public Downloader(String url, File destination, DownloaderResponseBody.ProgressListener progressListener) {
        this.url = url;
        ...
        Interceptor interceptor = new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                return originalResponse.newBuilder()
                        .body(new DownloaderResponseBody(originalResponse.body(), progressListener))
                        .build();
            }
        };
